...
from Projects.views import (home,request_pr,response_pr,leaderboard,profile,remove_issue,remove_pr,contri_user,vote,change_label,new_issue)
...
urlpatterns = [
    ...
    path('new_issue', new_issue , name='new_issue'),
    path('remove_pr', remove_pr , name='remove_pr'),
    path('change_label',change_label, name='change_label'),
